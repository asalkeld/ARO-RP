...
// Source: github.com/Azure/ARO-RP/pkg/util/azureclient/mgmt/resources (interfaces: DeploymentsClient,GroupsClient,ProvidersClient,ResourcesClient)
...
func (m *MockGroupsClient) CreateOrUpdate(arg0 context.Context, arg1 string, arg2 features.ResourceGroup) (features.ResourceGroup, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method
func (m *MockGroupsClient) Get(arg0 context.Context, arg1 string) (features.ResourceGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockResourcesClient) ListWithDetails(arg0 context.Context, arg1, arg2 string, arg3 *int32) (features.ResourceListResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListWithDetails", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(features.ResourceListResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListWithDetails indicates an expected call of ListWithDetails
func (mr *MockResourcesClientMockRecorder) ListWithDetails(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListWithDetails", reflect.TypeOf((*MockResourcesClient)(nil).ListWithDetails), arg0, arg1, arg2, arg3)
}
